...
<div class="container-fluid">
    ...
    <div class="card mb-3 shadow-sm border-0">
        <div class="card-body d-flex justify-content-between align-items-center" style="background-color: #f8f9fa;">
            <div>
                <h4 class="mb-1 fw-bold" style="color: #1B396A !important;">{{ $alumno->nombre }} {{ $alumno->ap_pat }} {{ $alumno->ap_mat }}</h4>
                <p class="mb-0 text-muted">
                    <strong>No. Control:</strong> {{ $alumno->n_control }} | 
                    <strong>Carrera:</strong> {{ $alumno->carrera->nombre_carrera ?? 'INGENIERÍA EN TICS' }}
                </p>
            </div>
            {{-- Enlace ajustado al dashboard de estudiante --}}
            <a href="{{ route('student.dashboard') }}" class="btn btn-outline-primary btn-sm" style="color: #1B396A; border-color: #1B396A;">
