...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="text-primary fw-bold mb-0" style="color: #1B396A !important;">
        ...
        {{-- Enlace ajustado para regresar al Dashboard de Estudiante --}}
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header" id="{{ $headingId }}">
                        <button class="accordion-button {{ $index !== 0 ? 'collapsed' : '' }} fw-bold text-dark bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $collapseId }}" aria-expanded="{{ $index === 0 ? 'true' : 'false' }}" aria-controls="{{ $collapseId }}">
                            ...
                            <i class="fas fa-book me-2" style="color: #1B396A;"></i> 
                            {{ $materia->nombre ?? 'Materia Desconocida' }}
                            <span class="ms-auto badge bg-primary me-2" style="background-color: #1B396A !important;">{{ $materia->cod_materia ?? '' }}</span>
                        </button>
                    </h2>
    ...
    {{-- SECCIÓN 2: HISTORIAL BOLETA --}}
    <div class="mt-5">
        <h5 class="border-bottom pb-2 mb-3 text-dark"><i class="fas fa-history me-2"></i> Consulta de Boletas Anteriores</h5>
        
        <div class="card shadow-sm border-0 mb-4 no-print">
            <div class="card-body bg-light">
                {{-- Ruta ajustada para el portal de estudiante --}}
                <form action="{{ route('student.calificaciones') }}" method="GET" class="row align-items-end">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #1B396A; border-color: #1B396A;">
        ...
        @elseif($boletasHistorial->isNotEmpty())
            ...
            <div class="text-center mt-3 mb-5">
                <button onclick="window.print()" class="btn btn-dark" style="background-color: #1B396A; border-color: #1B396A;">
...
<style>
    @media print {
        ...
        .no-print, .btn, header, footer, nav, .sidebar { display: none !important; }
