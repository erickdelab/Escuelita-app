...
<head>
    ...
    <title>Portal Estudiante | {{ config('app.name', 'TecNM') }}</title>
...
<body>
    ...
    <nav class="top-navbar justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-sm-block lh-1">
                    ...
                    <div class="fw-bold">Instituto Tecnológico de Puebla</div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center gap-3">
            <span class="d-none d-md-block text-white small text-uppercase">
                {{ auth()->user()->alumnoData->carrera->nombre_carrera ?? 'Estudiante' }}
            </span>
    ...
    <div class="sidebar">
        <nav class="nav flex-column">
            <div class="px-3 py-2 text-muted small text-uppercase fw-bold">Menú Principal</div>
            
            <a href="{{ route('student.dashboard') }}" class="nav-link {{ request()->routeIs('student.dashboard') ? 'active' : '' }}">
                <i class="bi bi-house-door"></i> Inicio
            </a>
            
            <a href="{{ route('student.horario') }}" class="nav-link {{ request()->routeIs('student.horario') ? 'active' : '' }}">
                <i class="bi bi-calendar-week"></i> Horario
            </a>
            
            <a href="{{ route('student.calificaciones') }}" class="nav-link {{ request()->routeIs('student.calificaciones') ? 'active' : '' }}">
                <i class="bi bi-clipboard-check"></i> Calificaciones
            </a>
            
            <a href="{{ route('student.kardex') }}" class="nav-link {{ request()->routeIs('student.kardex') ? 'active' : '' }}">
                <i class="bi bi-journal-bookmark"></i> Kárdex
            </a>

            <div class="my-2 border-top mx-3"></div>
            
            <div class="px-3 py-2 text-muted small text-uppercase fw-bold">Trámites</div>

            <a href="{{ route('student.carga') }}" class="nav-link {{ request()->routeIs('student.carga') ? 'active' : '' }}">
                <i class="bi bi-collection"></i> Carga de Materias
            </a>
        </nav>
    </div>
